        ...
        <ul className="nav" role="navigation">
          <li className="logo">
            <a href="#about">
              <img
                className="logo"
                src={"https://i.ibb.co/r5YwMmr/logo-Imgur.png"}
                alt=" logo"
              ></img>
            </a>
          </li>
          <li className="logo-title">CREDit</li>
      ...
      <section className="header">
        <div className="header-container">
          <div className="left-section">
            ...
            <p>
              Bank Admins click on TOP RIGHT 👆".
              <br />
              ...
              >
                ...
                <div className="face face1">
                  <div className="content">
                    <img src={createPageImage} alt=""></img>
                    <h3>Apply</h3>
                  </div>
                </div>
          ...
          <div className="row">
            <div className="col">
              ...
              >
                ...
                <div className="face face1">
                  <div className="content">
                    <img src={shareLinkImage} alt="page"></img>
              ...
              <div className="card">
                ...
                <div className="face face1">
                  <div className="content">
                    <img
                      src={ConnectAllImage}
                      alt="Share link and connect with all"
                    ></img>
                    <h3>Accept/Reject</h3>
                  </div>
                </div>
            ...
            <div className="col-xs-12 col-sm-6 col-md-6 col-lg-6 col-xl-6">
              <div className="footer-logo">
                <img
                  ...
                  alt="logo"
                ></img>
                <h1 className="logo-title">CREDit</h1>
